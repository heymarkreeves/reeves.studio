        ...
        <div class="wrapper">
          <strong class="brand">
            ...
            <g-link class="brand-link" to="/">
              <div class="brand-sm">
                <svg width="100%" height="100%" viewBox="0 0 217 193" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="
                    fill-rule: evenodd;
                    clip-rule: evenodd;
