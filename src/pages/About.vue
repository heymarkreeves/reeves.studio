<template>
  <Layout>
    ...
    <div class="wrapper panel-alternating">
      <p>
        As a front end web developer rooted in back end engineering, if you were
        to describe Mark with one word it would be
      ...
      <p>
        ...
        inclusive for more people, or more sustainable for the planet &amp; the
        people who work with them, Mark&rsquo;s motivated to
        <strong>always do better</strong> at the work we&nbsp;do.
      </p>
      <p>
        Mark lives with his family and works remotely in
        Montpelier,&nbsp;Vermont.
      </p>
    </div>
    <ContactForm />
