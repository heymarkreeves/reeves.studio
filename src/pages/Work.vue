  ...
  <Layout>
    ...
    <div class="panel panel-work work-morins">
      <div
        ...
        :style="{
          backgroundImage: 'url(' + require('@/assets/img/morins-bg.jpg') + ')',
        }"
      >
        <g-image
          class="logo-morins"
    ...
    <div class="panel panel-work work-jn">
      <div
        ...
        :style="{
          backgroundImage:
            'url(' + require('@/assets/img/monarch-bg.jpg') + ')',
        }"
      >
        <g-image
          class="photo-jn"
...
.panel-work {
  .image {
    ...
    @include remify("min-height", 200px);
    &.image-logo {
...
.work-idg {
  .image {
    ...
    svg {
      @include remify("max-width", 240px);
    }
